...
# Criando grupos de segurança para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
...
# Criando grupos de seguranca para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
...
# Criando conjunto de opções de DHCP para a vpc. O nome da vpc será usado como nome de domínio
...
# Criando arquivo ${vpc_name}_vars.sh com o dump das variáveis de ambiente

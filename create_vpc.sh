...
# Criar um internet gateway (para permitir subredes públicas terem acesso à internet)
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Gateway das Subredes Publicas - ${vpc_name}"
...
# Criar tabelas de roteamento para subredes públicas e privadas
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Tabela de Roteamento das Subredes Publicas - ${vpc_name}"
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Tabela de Roteamento da Subrede Privada 01 - ${vpc_name}"
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Tabela de Roteamento da Subrede Privada 02 - ${vpc_name}"
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Tabela de Roteamento da Subrede Privada 03 - ${vpc_name}"
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Tabela de Roteamento da Subrede Privada 04 - ${vpc_name}"
...
# Subrede Pública 01 - ${cidr}.0.0/24 - zona de disponibilidade ${availability_zone_1}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Publica 01 - ${vpc_name}"
...
# Subrede Privada 01 - ${cidr}.1.0/24 - zona de disponibilidade ${availability_zone_1}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Privada 01 - ${vpc_name}"
...
# Subrede Pública 02 - ${cidr}.2.0/24 - zona de disponibilidade ${availability_zone_2}
    ...
    subnetid_3=$(aws --profile ${profile} ec2 create-subnet \
        --vpc-id ${vpc_id} --cidr-block ${cidr}.2.0/24 \
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Publica 02 - ${vpc_name}"
...
# Subrede Privada 02 - ${cidr}.3.0/24 - zona de disponibilidade ${availability_zone_2}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Privada 02 - ${vpc_name}"
...
# Subrede Pública 03 - ${cidr}.4.0/24 - zona de disponibilidade ${availability_zone_3}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Publica 03 - ${vpc_name}"
...
# Subrede Privada 03 - ${cidr}.5.0/24 - zona de disponibilidade ${availability_zone_3}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Privada 03 - ${vpc_name}"
...
# Subrede Pública 04 - ${cidr}.6.0/24 - zona de disponibilidade ${availability_zone_4}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Publica 04 - ${vpc_name}"
...
# Subrede Privada 04 - ${cidr}.7.0/24 - zona de disponibilidade ${availability_zone_4}
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="Subrede Privada 04 - ${vpc_name}"
...
# Criar grupos de segurança para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
    ...
    security_group_NAT1=$(aws --profile ${profile} ec2 create-security-group \
        --group-name "NAT-${availability_zone_1}-${vpc_name}" \
        --description "Regras de Seguranca para a instancia NAT - ${vpc_name}" \
        --vpc-id ${vpc_id} \
        --query 'GroupId')
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="SecGrpNAT1"
...
# Criar grupos de segurança para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
    ...
    security_group_NAT3=$(aws --profile ${profile} ec2 create-security-group \
        --group-name "NAT-${availability_zone_2}-${vpc_name}" \
        --description "Regras de Seguranca para a instancia NAT - ${vpc_name}" \
        --vpc-id ${vpc_id} \
        --query 'GroupId')
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="SecGrpNAT3"
...
# Criar grupos de segurança para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
    ...
    security_group_NAT5=$(aws --profile ${profile} ec2 create-security-group \
        --group-name "NAT-${availability_zone_3}-${vpc_name}" \
        --description "Regras de Seguranca para a instancia NAT - ${vpc_name}" \
        --vpc-id ${vpc_id} \
        --query 'GroupId')
...
# * Criar grupos de seguranca para as instâncias NAT, localizadas nas subredes Públicas, liberando acesso para as subredes privadas acessarem a internet
    ...
    security_group_NAT7=$(aws --profile ${profile} ec2 create-security-group \
        --group-name "NAT-${availability_zone_4}-${vpc_name}" \
        --description "Regras de Seguranca para a instancia NAT - ${vpc_name}" \
        --vpc-id ${vpc_id} \
        --query 'GroupId')
    ...
    aws --profile ${profile} ec2 create-tags \
        ...
        --tags Key=Name,Value="SecGrpNAT7"
...
# Criar domínio interno da VPC
    ...
    create_hosted_zone_json_output=$(aws --profile ${profile} route53 create-hosted-zone \
        --name ${vpc_name} \
